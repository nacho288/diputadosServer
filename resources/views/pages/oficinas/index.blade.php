      ...
      <div class="row justify-content-center mt-5 animated fadeIn mb-5">
        ...
        <div class="col col-auto bg-white rounded shadow-sm">
            ...
            <div class="row justify-content-between align-items-center mb-0 animated fadeIn fast">
                <div class="col mt-3">
                    <h2 class="blued mb-0">Listado de oficinas</h2>
                </div>
                <div class="col col-auto mt-3 text-right">
                    <a class="btn btn-sm btnColor" href="/oficinas/create">Agregar</a>
                </div>
            </div>
                ...
                <div class="col">
                    <table  id="example" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <b class="mr-4">{{  $oficina->nombre }}</b>
                                </td>
                                <td>
                                    <a href="/oficinas/{{  $oficina->id }}" class="ml-4 badge btnColor">Detalles</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
